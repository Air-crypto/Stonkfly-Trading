...
def audit_chunk(envelope, summary, root, data):
    ...
    require(r['study']=='11' and summary['registration']==r and summary['plan_sha256']==envelope['sha256'], 'Online protocol differs')
    stage, pool, name = summary['stage'], summary['pool_index'], summary['arm']
    require(summary['status']=='paper_online_chunk_completed' and summary['chunk']==chunk_name(stage,pool,name), 'Chunk identity differs')
    ...
    if events:
        ...
        require(config=={'preset':'market_replay','view':'original','news':'sealed_timestamped','eta':.001,
        ...
        require(report['evaluation_phase']==stage and report['memory_origin']==arm['memory'] and
            ...
            report['study']=='11' and report['native_build']==summary['native_build'], 'Viewer provenance differs')
    ...
    result={'status':'paper_online_chunk_audited','chunk':summary['chunk'],'plan_sha256':envelope['sha256'],
